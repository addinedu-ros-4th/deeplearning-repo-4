...
class WindowClass(QMainWindow, from_class):
    def __init__(self):
        ...
        self.client_thread.mycurrentMove.connect(self.mycurrentMove)
        self.client_thread.aicurrentMove.connect(self.aicurrentMove)
        self.client_thread.captured.connect(self.captured)
                ...
                if is_turn == True and yolo_fen == chess_module_fen and is_moving == False:
                    ...
                    if count > 10:
                        ...
                        if chess.Move.from_uci(changes) in self.env.board.legal_moves:
                            ...
                            self.aicurrentMove.emit(changes)
