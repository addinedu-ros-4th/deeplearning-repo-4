...
class Config:
    ...
    def __init__(self, config_type="mini"):
        ...
        if config_type == "mini":
            import alpha_zero_model.src.chess_zero.configs.mini as c
        elif config_type == "normal":
            import alpha_zero_model.src.chess_zero.configs.normal as c
        elif config_type == "distributed":
            import alpha_zero_model.src.chess_zero.configs.distributed as c
        else:
